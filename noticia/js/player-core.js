class KiwiVSLPlayer {
  ...
  get video_markup() {
    ...
    html =
      `
    <video id="player${this.index}" data-poster="https://i.ytimg.com/vi/${this.video_id}/maxresdefault.jpg" webkit-playsinline playsinline controlsList="nofullscreen">
      ${sources}
    </video>`;
  ...
  get videothumbnail_markup() {
    ...
    html =
      `
    <video id="player${this.index}_vt" class="kiwivsl-videothumbnail" webkit-playsinline playsinline controlsList="nofullscreen">
      ${sources}
    </video>`;
